...
class Accel {
    ...
    public:
        ...
        const QuaternionInt getDeviceOrientation(const QuaternionInt &absolutePosition) const;
        ...
        const QuaternionInt getAbsoluteOrientation(const QuaternionInt &deviceVector) const;
};
