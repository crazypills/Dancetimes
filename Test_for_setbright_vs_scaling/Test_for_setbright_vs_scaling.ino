...
NeoPatterns Stick(36, 6, NEO_GRB + NEO_KHZ800, &StickComplete);
...
bool Lighton = false;
unsigned long cycletime = 350;
unsigned long offtime = 80;
    ...
    if ( millis() - lastCycle > cycletime)
    {
      ...
      if (digitalRead(9) == LOW)
      {
        if (Lighton)
        {
          ...
          Lighton = false;
          Stick.Color1 = Stick.DimColor(Stick.Color1);
        }
      }
      else
      {
...
//      {
//        Stick.Follower(Stick.Color(255,0,255),250,5);
//      }
//      //Ring.Update();
//      Stick.Update();
//    }
...
////      {
////        Ring.HalfUpDown(random(255),250);
////      }
//      if(Stick.ActivePattern != DOUBLESCANNER)
//      {
//        Stick.DoubleScanner(random(255),80);
//      }
////      Ring.Update();
//      Stick.Update();
//    }
...
//      Stick.SetBlank(false);
      ...
      if(Stick.ActivePattern != HALFUPDOWN)
      {
        ...
        //Stick.RunningRainbow(Stick.Wheel(random(255)),200);
        //Stick.TheaterChase(Stick.Color(0,255,255),Stick.Color(255,0,255), 250 , FORWARD);
        Stick.HalfUpDown(Stick.Color(0,255,255),200);
