...
//      }
      ...
      {
        Stick.Follower(Stick.Color(255,0,255),300,5);
      }
      //Ring.Update();
      Stick.Update();
    }
...
//      }
      ...
      {
        Stick.DoubleScanner(random(255),40);
      }
//      Ring.Update();
      Stick.Update();
    }
...
//      Stick.SetBlank(false);
      ...
      if(Stick.ActivePattern != RAINBOW_CYCLE)
      {
        ...
        //Stick.RunningRainbow(Stick.Wheel(random(255)),120);
        ...
        //Stick.Twinkle(45,200);
        Stick.RainbowCycle(20, FORWARD);
      }
